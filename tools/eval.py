...
def parse_args():
    ...
    parser.add_argument('--eval_imgs', dest='eval_imgs',
                        ...
                        default='/root/userfolder/yx/data/voc2007_test/VOCdevkit/VOC2007/JPEGImages', type=str)
    parser.add_argument('--annotation_dir', dest='test_annotation_dir',
                        help='the dir save annotations',
                        default='/root/userfolder/yx/data/voc2007_test/VOCdevkit/VOC2007/Annotations', type=str)
